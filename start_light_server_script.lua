...
function tl.trackHasLightMesh()
  return (SLightsDataConnection.lightsOnTrack or SLightsDataConnection.lightsOnTrackServer) and
      SLightsDataConnection.trackLightPosition or
